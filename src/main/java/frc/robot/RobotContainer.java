                ...
                switch (Constants.currentMode) {
                        case REAL:
                                ...
                                vision = new Vision(drive::addVisionMeasurement,
                                                new VisionIOPhotonVision("Left", null));
                                break;
                        ...
                        case SIM:
                                ...
                                vision = new Vision(
                                                ...
                                                new VisionIOPhotonVisionSim(
                                                                "Front",
                                                                new Transform3d(0.2, 0.0, 0.5,
                                                                                new Rotation3d(0, -Math.PI / 7., 0.0)),
                                                                drive::getPose),
                                                new VisionIOPhotonVisionSim(
                                                                "Left",
                                                                new Transform3d(0.0, 0.2, 0.5,
                                                                                new Rotation3d(0, -Math.PI / 7.,
                                                                                                Math.PI / 2.)),
                                                                drive::getPose),
                                                new VisionIOPhotonVisionSim(
                                                                "Right",
                                ...
                                DriveCommands.joystickDrive(
                                                ...
                                                () -> -1
                                                                * (shooter.isActivelyShooting()
                                                                                ? yInputAverage.calculate(
                                                                                                controller.getLeftY())
                                                                                : controller.getLeftY()),
                                                () -> -1
                                                                * (shooter.isActivelyShooting()
                                                                                ? xInputAverage.calculate(
                                                                                                controller.getLeftX())
                                                                                : controller.getLeftX()),
