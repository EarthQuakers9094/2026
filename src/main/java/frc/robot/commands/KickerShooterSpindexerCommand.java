...
public class KickerShooterSpindexerCommand extends SequentialCommandGroup {
  /** Creates a new KickerShooterSpindexerCommand. */
  public KickerShooterSpindexerCommand(
