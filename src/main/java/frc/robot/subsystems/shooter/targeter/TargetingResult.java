...
public class TargetingResult {
  public record TargetingResult2d(double targetRPM,double pitchRadians, double timeOfFlightSeconds) {}

  public record TargetingResult3d(double pitchRadians, double targetRPM, double yawRadians, double timeOfFlightSeconds) {
